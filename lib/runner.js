...
module.exports = {
    ...
    /**
     * Sets the options to be used by dist. Must be called before running
     * any of the functions in runner.
     * 
     ...
     */
    clean: function() {
        console.log("Cleaning " + options.dist.dest)
    ...
    watch: function() {
        ...
        chokidar.watch(options.dist.dest).on("all", (event, path) => {
            //console.log(path + " has been modified (" + event + "). Reloading...");
